...
evaluationDependsOn(":runtime:minecraft-fabric-1.20.3")
val runtimeFabricProject = project(":runtime:minecraft-fabric-1.20.3")
...
fabricApi {
    configureTests {
        ...
        modId = "strata-integration-minecraft-fabric-1-20-3"
...
tasks.named<ProcessResources>("processGametestResources") {
    ...
    inputs.property("minecraftVersion", libs.versions.minecraft1203)
    inputs.property("integrationModId", "strata-integration-minecraft-fabric-1-20-3")
    inputs.property("runtimeModId", "strata-runtime-minecraft-fabric-1-20-3")
    filesMatching("fabric.mod.json") {
        expand(
            "version" to project.version,
            "minecraftVersion" to libs.versions.minecraft1203.get(),
            "integrationModId" to "strata-integration-minecraft-fabric-1-20-3",
            "runtimeModId" to "strata-runtime-minecraft-fabric-1-20-3",
        )
    }
}

dependencies {
    minecraft(libs.minecraft1203)
    mappings(loom.officialMojangMappings())
    modImplementation(libs.fabric.loader)
    modImplementation(libs.fabric.api1203)
    ...
    add("productionRuntimeMods", libs.fabric.api1203)
...
val runProductionClientGameTest = tasks.register<ClientProductionRunTask>("runProductionClientGameTest") {
    ...
    jvmArgs.add(libs.versions.minecraft1203.map { version -> "-Dstrata.minecraftVersion=$version" })
}
...
tasks.named<JavaExec>("runClientGameTest") {
    ...
    doFirst {
        ...
        systemProperty("strata.minecraftVersion", libs.versions.minecraft1203.get())
    }
}
