...
evaluationDependsOn(":runtime:minecraft-fabric-1.21.6")
val runtimeFabricProject = project(":runtime:minecraft-fabric-1.21.6")
...
fabricApi {
    configureTests {
        ...
        modId = "strata-integration-minecraft-fabric-1-21-6"
...
tasks.named<ProcessResources>("processGametestResources") {
    ...
    inputs.property("minecraftVersion", libs.versions.minecraft1216)
    inputs.property("integrationModId", "strata-integration-minecraft-fabric-1-21-6")
    inputs.property("runtimeModId", "strata-runtime-minecraft-fabric-1-21-6")
    filesMatching("fabric.mod.json") {
        expand(
            "version" to project.version,
            "minecraftVersion" to libs.versions.minecraft1216.get(),
            "integrationModId" to "strata-integration-minecraft-fabric-1-21-6",
            "runtimeModId" to "strata-runtime-minecraft-fabric-1-21-6",
        )
    }
}

dependencies {
    minecraft(libs.minecraft1216)
    mappings(loom.officialMojangMappings())
    modImplementation(libs.fabric.loader)
    modImplementation(libs.fabric.api1216)
    ...
    add("productionRuntimeMods", libs.fabric.api1216)
...
val runProductionClientGameTest = tasks.register<ClientProductionRunTask>("runProductionClientGameTest") {
    ...
    jvmArgs.add(libs.versions.minecraft1216.map { version -> "-Dstrata.minecraftVersion=$version" })
}
...
tasks.named<JavaExec>("runClientGameTest") {
    ...
    doFirst {
        ...
        systemProperty("strata.minecraftVersion", libs.versions.minecraft1216.get())
    }
}
