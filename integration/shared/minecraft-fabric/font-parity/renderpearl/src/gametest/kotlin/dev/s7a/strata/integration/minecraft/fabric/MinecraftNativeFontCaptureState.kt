...
internal class MinecraftNativeFontCaptureState(
    ...
    private class Pipeline(
        ...
        format: GpuFormat,
            ...
            original.isCull,
            original.vertexFormatBindings.toTypedArray(),
        ...
        private companion object {
            private fun colorTargets(
                ...
                val target = checkNotNull(original.colorTargetStates.single()) { "Native font capture requires a color attachment declaration." }
