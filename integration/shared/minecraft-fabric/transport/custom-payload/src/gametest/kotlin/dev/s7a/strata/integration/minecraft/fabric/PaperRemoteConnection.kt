...
internal fun connectPaperTest(
    ...
    ConnectScreen.startConnecting(TitleScreen(), minecraft, ServerAddress.parseString(address), ServerData("Strata acceptance", address, ServerData.Type.OTHER), false)
}
...
internal fun disconnectPaperTest(minecraft: Minecraft) {
    ...
    minecraft.disconnect(TitleScreen())
}
