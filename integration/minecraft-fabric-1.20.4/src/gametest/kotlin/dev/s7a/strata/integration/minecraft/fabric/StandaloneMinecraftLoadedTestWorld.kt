...
/**
 * Owns one disposable Minecraft 1.20.4 singleplayer world created by [StandaloneMinecraftLoadedTestContext].
 *
...
internal class StandaloneMinecraftLoadedTestWorld(
    ...
    override fun close() {
        context.computeOnClient { minecraft ->
            ...
            minecraft.disconnect(GenericDirtMessageScreen(Component.translatable("menu.savingLevel")))
        }
