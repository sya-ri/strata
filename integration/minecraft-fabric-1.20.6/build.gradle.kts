...
evaluationDependsOn(":runtime:minecraft-fabric-1.20.6")
val runtimeFabricProject = project(":runtime:minecraft-fabric-1.20.6")
...
fabricApi {
    configureTests {
        ...
        modId = "strata-integration-minecraft-fabric-1-20-6"
...
tasks.named<ProcessResources>("processGametestResources") {
    ...
    inputs.property("minecraftVersion", libs.versions.minecraft1206)
    inputs.property("integrationModId", "strata-integration-minecraft-fabric-1-20-6")
    inputs.property("runtimeModId", "strata-runtime-minecraft-fabric-1-20-6")
    filesMatching("fabric.mod.json") {
        expand(
            "version" to project.version,
            "minecraftVersion" to libs.versions.minecraft1206.get(),
            "integrationModId" to "strata-integration-minecraft-fabric-1-20-6",
            "runtimeModId" to "strata-runtime-minecraft-fabric-1-20-6",
        )
    }
}
...
dependencies {
    ...
    add("productionRuntimeMods", libs.fabric.api1206)
...
val runProductionClientGameTest = tasks.register<ClientProductionRunTask>("runProductionClientGameTest") {
    ...
    dependsOn(deleteProductionGameTestRunDir, ":runtime:minecraft-fabric-1.20.6:remapJar")
    ...
    jvmArgs.add(libs.versions.minecraft1206.map { version -> "-Dstrata.minecraftVersion=$version" })
}
...
tasks.named<JavaExec>("runClientGameTest") {
    ...
    doFirst {
        ...
        systemProperty("strata.minecraftVersion", libs.versions.minecraft1206.get())
    }
}
