...
fabricApi {
    configureTests {
        ...
        modId = "strata-integration-minecraft-fabric-1-21-4"
...
tasks.named<ProcessResources>("processGametestResources") {
    ...
    inputs.property("minecraftVersion", libs.versions.minecraft1214)
    inputs.property("integrationModId", "strata-integration-minecraft-fabric-1-21-4")
    inputs.property("runtimeModId", "strata-runtime-minecraft-fabric-1-21-4")
    filesMatching("fabric.mod.json") {
        expand(
            "version" to project.version,
            "minecraftVersion" to libs.versions.minecraft1214.get(),
            "integrationModId" to "strata-integration-minecraft-fabric-1-21-4",
            "runtimeModId" to "strata-runtime-minecraft-fabric-1-21-4",
        )
    }
}
...
dependencies {
    ...
    add("productionRuntimeMods", libs.fabric.api1214)
...
val runProductionClientGameTest = tasks.register<ClientProductionRunTask>("runProductionClientGameTest") {
    ...
    dependsOn(deleteProductionGameTestRunDir, ":runtime:minecraft-fabric-1.21.4:remapJar")
    ...
    jvmArgs.add(libs.versions.minecraft1214.map { version -> "-Dstrata.minecraftVersion=$version" })
}
...
tasks.named<JavaExec>("runClientGameTest") {
    ...
    doFirst {
        ...
        systemProperty("strata.minecraftVersion", libs.versions.minecraft1214.get())
    }
}
