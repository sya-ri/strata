...
internal class ShowcaseStorageSynchronizerTest {
    ...
    fun generationRemovesStaleFilesAndLeavesExactManifest() {
        ...
        Files.writeString(target.resolve("minecraft-26.3-parity.properties"), "old-generated-proof")
        val evidence = temporaryRoot.resolve("docs/evidence/minecraft-26.3-parity.properties")
