...
internal object ReadmeDemoPipeline {
    ...
    private fun markdown(sources: Map<ReadmeDemoStage, ReadmeDemoSource>): String =
        buildString {
            ...
            appendLine("Copy [the final screen](../../${ReadmeDemoSource.DIRECTORY}/ScrollPlayersExample.kt), [the player model](../../${ReadmeDemoSource.DIRECTORY}/ReadmePlayer.kt), and [the screen chrome](../../${ReadmeDemoSource.DIRECTORY}/ReadmeDemoChrome.kt) into a Mod using Strata, then call `scrollPlayersScreen(players, panel).open()`.")
