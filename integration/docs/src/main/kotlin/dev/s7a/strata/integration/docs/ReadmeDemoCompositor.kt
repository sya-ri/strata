...
internal object ReadmeDemoCompositor {
    /**
     * Composes a 1200 by 1500 frame; the supplied 512 by 384 PNG is copied at its original density.
    ...
    fun compose(
        ...
        val image = BufferedImage(1200, 1500, BufferedImage.TYPE_INT_RGB)
        ...
        try {
            ...
            graphics.fillRect(0, 0, 648, 1500)
            graphics.drawImage(preview, 672, 558, null)
