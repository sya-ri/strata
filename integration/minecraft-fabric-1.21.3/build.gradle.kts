...
evaluationDependsOn(":runtime:minecraft-fabric-1.21.3")
val runtimeFabricProject = project(":runtime:minecraft-fabric-1.21.3")
...
fabricApi {
    configureTests {
        ...
        modId = "strata-integration-minecraft-fabric-1-21-3"
...
tasks.named<ProcessResources>("processGametestResources") {
    ...
    inputs.property("integrationModId", "strata-integration-minecraft-fabric-1-21-3")
    inputs.property("runtimeModId", "strata-runtime-minecraft-fabric-1-21-3")
    filesMatching("fabric.mod.json") {
        expand(
            "version" to project.version,
            "minecraftVersion" to libs.versions.minecraft1213.get(),
            "integrationModId" to "strata-integration-minecraft-fabric-1-21-3",
            "runtimeModId" to "strata-runtime-minecraft-fabric-1-21-3",
        )
    }
}
...
dependencies {
    ...
    modImplementation(libs.fabric.api1213)
    ...
    add("productionRuntimeMods", libs.fabric.api1213)
...
val runProductionClientGameTest = tasks.register<ClientProductionRunTask>("runProductionClientGameTest") {
    ...
    dependsOn(deleteProductionGameTestRunDir, ":runtime:minecraft-fabric-1.21.3:remapJar")
    ...
    jvmArgs.add(libs.versions.minecraft1213.map { version -> "-Dstrata.minecraftVersion=$version" })
}
...
tasks.named<JavaExec>("runClientGameTest") {
    ...
    doFirst {
        ...
        systemProperty("strata.minecraftVersion", libs.versions.minecraft1213.get())
    }
}
