...
evaluationDependsOn(":runtime:minecraft-fabric-1.20.5")
val runtimeFabricProject = project(":runtime:minecraft-fabric-1.20.5")
...
fabricApi {
    configureTests {
        ...
        modId = "strata-integration-minecraft-fabric-1-20-5"
...
tasks.named<ProcessResources>("processGametestResources") {
    ...
    inputs.property("runtimeModId", "strata-runtime-minecraft-fabric-1-20-5")
    filesMatching("fabric.mod.json") {
        expand(
            "version" to project.version,
            "minecraftVersion" to libs.versions.minecraft1205.get(),
            "integrationModId" to "strata-integration-minecraft-fabric-1-20-5",
            "runtimeModId" to "strata-runtime-minecraft-fabric-1-20-5",
        )
    }
}

dependencies {
    minecraft(libs.minecraft1205)
    mappings(loom.officialMojangMappings())
    modImplementation(libs.fabric.loader)
    modImplementation(libs.fabric.api1205)
...
val runProductionClientGameTest = tasks.register<ClientProductionRunTask>("runProductionClientGameTest") {
    ...
    dependsOn(deleteProductionGameTestRunDir, ":runtime:minecraft-fabric-1.20.5:remapJar")
...
tasks.named<JavaExec>("runClientGameTest") {
    ...
    doFirst {
        ...
        systemProperty("strata.minecraftVersion", libs.versions.minecraft1205.get())
    }
}
