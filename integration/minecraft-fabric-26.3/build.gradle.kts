...
extensions.configure<DetektExtension> {
    source.from(fontParityGameTest.resolve("kotlin"), nativeFontParityGameTest.resolve("kotlin"), rootProject.file("integration/minecraft-font-parity-renderpearl/src/gametest/kotlin"))
}
...
extensions.configure<KotlinJvmProjectExtension> {
    sourceSets.named("gametest") {
        ...
        kotlin.srcDir(rootProject.file("integration/minecraft-font-parity-renderpearl/src/gametest/kotlin"))
    }
}
