...
val runtimeFabricProject = project(":runtime:minecraft-fabric-1.21.10")
...
fabricApi {
    configureTests {
        ...
        modId = "strata-integration-minecraft-fabric-1-21-10"
...
tasks.named<ProcessResources>("processGametestResources") {
    ...
    inputs.property("minecraftVersion", libs.versions.minecraft12110)
    inputs.property("integrationModId", "strata-integration-minecraft-fabric-1-21-10")
    inputs.property("runtimeModId", "strata-runtime-minecraft-fabric-1-21-10")
    filesMatching("fabric.mod.json") {
        expand(
            "version" to project.version,
            "minecraftVersion" to libs.versions.minecraft12110.get(),
            "integrationModId" to "strata-integration-minecraft-fabric-1-21-10",
            "runtimeModId" to "strata-runtime-minecraft-fabric-1-21-10",
        )
    }
}

dependencies {
    minecraft(libs.minecraft12110)
    mappings(loom.officialMojangMappings())
    modImplementation(libs.fabric.loader)
    modImplementation(libs.fabric.api12110)
    ...
    add("productionRuntimeMods", libs.fabric.api12110)
...
tasks.named("remapJar") {
    mustRunAfter(":runtime:minecraft-fabric-1.21.10:remapJar")
}
...
val runProductionClientGameTest = tasks.register<ClientProductionRunTask>("runProductionClientGameTest") {
    ...
    dependsOn(deleteProductionGameTestRunDir, ":runtime:minecraft-fabric-1.21.10:remapJar")
    ...
    jvmArgs.add(libs.versions.minecraft12110.map { version -> "-Dstrata.minecraftVersion=$version" })
}
...
tasks.named<JavaExec>("runClientGameTest") {
    ...
    doFirst {
        ...
        systemProperty("strata.minecraftVersion", libs.versions.minecraft12110.get())
    }
}
