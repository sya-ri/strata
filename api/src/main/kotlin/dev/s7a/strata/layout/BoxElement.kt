...
/**
 * Internal immutable description for a box container.
 *
...
internal class BoxElement(
    ...
    /**
     * Retained node that measures every child and places each child in the box.
     *
    ...
    internal class Node(
        ...
        override fun layout(scope: LayoutScope) {
            for (index in 0 until scope.childCount) {
                ...
                val alignment = scope.childParentData(index, BoxAlignmentParentData.KEY)?.alignment ?: contentAlignment
    ...
    /**
     * Stable token for the box component.
     */
    companion object {
        internal val TYPE: ElementType<BoxElement, Node> =
            ElementType(
                elementClass = BoxElement::class,
