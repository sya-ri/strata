...
internal object ColumnAlignmentParentData {
    ...
    fun decode(value: ProjectionValue): ModifierElement {
        ...
        val result = Element(Data(HorizontalAlignment.entries[fields.int(HorizontalAlignment.entries.indices)]))
        fields.finish()
        return result
    }
    ...
    internal data class Element(
        ...
        override val projection: DeclarationProjection<*> get() = BuiltinProjection.ColumnAlignment.properties(ProjectionValue.Integer(data.alignment.ordinal.toLong()))
