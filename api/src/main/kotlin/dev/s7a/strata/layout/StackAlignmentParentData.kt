...
internal object StackAlignmentParentData {
    ...
    fun decode(value: ProjectionValue): ModifierElement {
        ...
        val result = Element(Data(Alignment.entries[fields.int(Alignment.entries.indices)]))
        fields.finish()
        return result
    }
    ...
    internal data class Element(
        ...
        override val projection: DeclarationProjection<*> get() = BuiltinProjection.StackAlignment.properties(ProjectionValue.Integer(data.alignment.ordinal.toLong()))
