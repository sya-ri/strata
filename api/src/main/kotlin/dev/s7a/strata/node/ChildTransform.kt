 ...
 *
 * A child point is mapped by multiplying both axes by [ChildTransform.scale], then adding [ChildTransform.offset] and the child's ordinary integer placement.
 ...
 * @throws IllegalArgumentException when [ChildTransform.scale] is not finite and positive.
 */
