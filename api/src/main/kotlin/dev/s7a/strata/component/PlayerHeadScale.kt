 ...
 *
 * Each factor maps one source skin texel to that many logical pixels, so [PlayerHeadScale.factor] one produces an 8 by 8 head and factor three produces a 24 by 24 head without uneven texel sizes.
 *
 * @property factor positive number of logical pixels per source texel.
 * @throws IllegalArgumentException when [PlayerHeadScale.factor] is not positive or the resulting logical size would overflow [Int].
 */
