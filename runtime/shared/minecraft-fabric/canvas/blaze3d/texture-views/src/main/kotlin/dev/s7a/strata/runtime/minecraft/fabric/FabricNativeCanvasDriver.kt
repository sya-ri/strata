...
/**
 * Implements the Blaze3D texture-view Canvas family with native GPU fences and version-owned OpenGL queue flushing.
 *
...
internal object FabricNativeCanvasDriver : NativeCanvasDriver {
    ...
    internal fun copy(
        ...
        device
            ...
            .use { pass ->
                ...
                pass.bindSampler("InSampler", sourceView)
                pass.draw(0, 3)
            }
    }
    ...
    private fun shader(
        ...
        when (stage) {
            ...
            ShaderType.FRAGMENT -> FabricNativeCanvasShaders.bufferedFragment(origin)
        }
}
