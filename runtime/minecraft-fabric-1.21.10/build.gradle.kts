...
tasks.named<ProcessResources>("processResources") {
    ...
    filesMatching("fabric.mod.json") {
        expand(
            ...
            "minecraft" to libs.versions.minecraft12110.get(),
...
val verifyFabricModArtifact = tasks.register("verifyFabricModArtifact") {
    ...
    doLast {
        ...
        ZipFile(artifact).use { archive ->
            ...
            check(metadata["id"] == "strata-runtime-minecraft-fabric-1-21-10") {
...
loom {
    mods {
        register("strata-runtime-minecraft-fabric-1.21.10") {
