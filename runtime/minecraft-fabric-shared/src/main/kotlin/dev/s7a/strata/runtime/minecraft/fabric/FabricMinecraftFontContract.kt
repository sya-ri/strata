 ...
 *
 * @throws IllegalArgumentException when JSON syntax, identifiers, provider filtering, mapping, metrics, or a provider that precedes the complete ASCII contract differs from the supported release contract.
...
private class MinecraftFontContractValidator(
    ...
    fun validate() {
        ...
        require(ascent == 7 && spaceAdvance == 4 && glyphs.size == 94) {
            "Minecraft font metadata does not provide the supported ASCII contract."
        }
    }
