...
public sealed interface DrawCommand {
     ...
     *
     * The source is nonempty and contained in [DrawCommand.BlitImage.image].
     ...
     * @throws IllegalArgumentException when the source is empty, outside [DrawCommand.BlitImage.image], or the destination is empty.
     */
     ...
     * @throws IllegalArgumentException when the source is empty, outside [DrawCommand.BlitImagePixels.image], or the destination is empty.
     */
     ...
     * Samples with multiplied alpha below [DrawCommand.SampledImage.alphaCutoff] are discarded before blending in command order.
     *
     ...
     * @throws IllegalArgumentException when a rectangle is empty, the source is outside [DrawCommand.SampledImage.image], or the cutoff is invalid.
     */
     ...
     *
     * Core retains [DrawCommand.Platform.command] by reference and does not interpret, copy, or clip it.
     ...
     * @throws IllegalArgumentException when [DrawCommand.Platform.bounds] is empty.
     */
