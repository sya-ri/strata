...
extensions.configure<DetektExtension> {
    source.from(rootProject.file("runtime/shared/minecraft-fabric/resources/event-callbacks/src/main/kotlin/dev/s7a/strata/runtime/minecraft/fabric/FabricMinecraftFontMapping.kt"))
}
...
tasks.named<ProcessResources>("processResources") {
    ...
    filesMatching("fabric.mod.json") {
        expand(
            ...
            "minecraft" to libs.versions.minecraft1219.get(),
