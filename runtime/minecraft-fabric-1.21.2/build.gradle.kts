...
val directSkinRuntime = rootProject.file("runtime/minecraft-fabric-1.21.3-legacy/src/main")

extensions.configure<SourceSetContainer> {
    named("main") {
        java.srcDirs(sharedRuntime.resolve("java"), legacyRuntime.resolve("java"), directSkinRuntime.resolve("java"))
...
tasks.named<ProcessResources>("processResources") {
    ...
    filesMatching("fabric.mod.json") {
        expand(
            ...
            "minecraft" to libs.versions.minecraft1212.get(),
...
val verifyFabricModArtifact = tasks.register("verifyFabricModArtifact") {
    ...
    doLast {
        ...
        ZipFile(artifact).use { archive ->
            ...
            check(metadata["id"] == "strata-runtime-minecraft-fabric-1-21-2") {
...
loom {
    mods {
        register("strata-runtime-minecraft-fabric-1.21.2") {
