 ...
 * The device registers an initialization fence, quarantines the target and permit until terminal GPU completion and an acknowledged physical release, and rethrows [NativeCanvasAllocationFailure.failure] as the primary allocation failure.
 ...
 * @param releaseRequested whether [NativeCanvasAllocationFailure.target] already accepted a successful close request; the device then only awaits physical acknowledgement and never repeats close.
 */
