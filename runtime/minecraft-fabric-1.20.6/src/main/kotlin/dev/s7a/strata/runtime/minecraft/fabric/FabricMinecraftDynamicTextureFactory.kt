...
/**
 * Indicates that Minecraft 1.20.6 nine-slice metadata tiles its center.
 */
@get:JvmSynthetic
...
/**
 * Reads the center mode represented by Minecraft 1.20.6's fixed tiled nine-slice record.
 */
@JvmSynthetic
