...
extensions.configure<DetektExtension> {
    source.from(primitiveInputRuntime.resolve("kotlin/dev/s7a/strata/runtime/minecraft/fabric/FabricMinecraftFontMapping.kt"))
}

extensions.configure<SourceSetContainer> {
    named("main") {
        java.srcDirs(sharedRuntime.resolve("java"), legacyRuntime.resolve("java"), primitiveInputRuntime.resolve("java"))
