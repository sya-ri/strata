...
extensions.configure<SourceSetContainer> {
    named("main") {
        java.srcDirs(
            ...
            rootProject.file("runtime/shared/minecraft-fabric/resources/identifier/src/main/java"),
        ...
        java.exclude { it.file == rootProject.file("runtime/shared/minecraft-fabric/screen/gui-graphics/src/main/java/dev/s7a/strata/runtime/minecraft/fabric/FabricMinecraftScreenAccess.java") }
    }
}
...
extensions.configure<KotlinJvmProjectExtension> {
    sourceSets.named("main") {
        kotlin.srcDirs(
            ...
            rootProject.file("runtime/shared/minecraft-fabric/resources/identifier/src/main/kotlin"),
