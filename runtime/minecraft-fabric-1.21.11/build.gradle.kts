...
extensions.configure<SourceSetContainer> {
    named("main") {
        java.srcDirs(
            sharedRuntime.resolve("java"),
            identifierRuntime.resolve("java"),
...
extensions.configure<KotlinJvmProjectExtension> {
    sourceSets.named("main") {
        kotlin.srcDirs(
            ...
            identifierRuntime.resolve("kotlin"),
...
val verifyFabricModArtifact = tasks.register("verifyFabricModArtifact") {
    ...
    doLast {
        ...
        ZipFile(artifact).use { archive ->
            ...
            check(metadata["id"] == "strata-runtime-minecraft-fabric-1-21-11") {
...
loom {
    mods {
        register("strata-runtime-minecraft-fabric-1.21.11") {
