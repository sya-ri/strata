...
/**
 * Converts one platform-neutral text value into an independent Minecraft 26.2 component tree.
 *
...
internal fun mapMinecraftText(text: UiText): Component =
    when (text) {
        ...
        is UiText.Platform -> throw IllegalArgumentException("Platform text has no safe 26.2 Component adapter.")
    }
