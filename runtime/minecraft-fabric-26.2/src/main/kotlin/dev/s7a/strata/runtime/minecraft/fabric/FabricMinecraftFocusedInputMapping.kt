...
/**
 * Maps one Minecraft 26.2 key press into the platform-neutral typed event without retaining the native record.
 *
...
/**
 * Maps one Minecraft 26.2 key release into the platform-neutral typed event without retaining the native record.
 *
 * @param event native immutable key record.
 * @return detached common event, or null for a key value below Minecraft's unknown sentinel.
 */
