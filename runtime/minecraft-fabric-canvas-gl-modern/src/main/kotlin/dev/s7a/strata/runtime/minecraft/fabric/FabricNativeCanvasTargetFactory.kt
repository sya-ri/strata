...
/**
 * Allocates a modern legacy-GL RGBA8 framebuffer on the render thread under the device's reserved lifetime permit.
 *
...
internal fun createCanvasRenderTarget(
    ...
    try {
        target.createBuffers(size.width, size.height)
