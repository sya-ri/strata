...
/**
 * Resolves and snapshots player skins through the resource-location API used through Minecraft 1.21.8.
 */
final class FabricMinecraftSkinBridge {
    ...
    static CompletableFuture<Optional<FabricMinecraftSkinReference>> lookup(
        ...
        if (source == PlayerSkinSource.CurrentPlayer.INSTANCE) {
            ...
            profile = unresolvedUuid(UuidKt.toJavaUuid(uuid.getValue()));
        } else {
