...
/**
 * Indicates that Minecraft 1.20.4 nine-slice metadata tiles its center.
 */
@get:JvmSynthetic
...
/**
 * Reads the center mode represented by Minecraft 1.20.4's fixed tiled nine-slice record.
 */
@JvmSynthetic
