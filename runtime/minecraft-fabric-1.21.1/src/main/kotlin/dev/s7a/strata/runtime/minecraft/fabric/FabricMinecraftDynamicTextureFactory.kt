...
/**
 * Stores one straight-ARGB pixel through Minecraft's pre-1.21.2 ABGR native-image API.
 */
@JvmSynthetic
...
/**
 * Indicates that Minecraft 1.21.1 nine-slice metadata always tiles its center.
 *
...
/**
 * Reads the center mode represented by Minecraft 1.21.1's fixed tiled nine-slice record.
 */
@JvmSynthetic
