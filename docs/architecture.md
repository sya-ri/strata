...
It covers both `ConfirmScreen` and an actual `ObjectSelectionList`, then writes the full Confirm frame and typed MenuBackground, Text, Button, and Scroll crops with their hashes below its build directory.
