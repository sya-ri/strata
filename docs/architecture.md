...
- `integration:minecraft-fabric-26.2` owns the loaded client vanilla parity scenes, integrated-server player/custom/ender-chest Slot scenarios, custom resource-pack-backed industrial screen, compiled Minecraft-component examples, and build-only verification evidence; it is not published.
