 ...
 *
 * @return callback-lifetime content reproducing the native list viewport, row geometry, separators, scrollbar, and text.
 */
internal fun scrollScreenContent(): MinecraftUiContext.() -> Element =
    {
        buildUi {
