...
The identifier root is limited to releases whose official mappings expose that native name; a release such as 1.21.10 with `ResourceLocation` owns compile-time aliases locally while reusing the same implementation source.
