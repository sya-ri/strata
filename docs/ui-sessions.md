...
Callers therefore declare `Text`, `Button`, `Tab`, `Slot`, `TextField`, `Scroll`, `Image`, and `PlayerHead` directly without an additional root builder or an explicit Minecraft context receiver.
