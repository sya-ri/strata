...
Offline tools can use `dev.s7a.strata:strata-runtime-minecraft-fonts-lwjgl:0.1.4` for resource decoding, TrueType rasterization, and text ordering without launching Minecraft.
