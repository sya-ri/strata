...
internal abstract class MavenCentralReleaseTask
    @Inject
    constructor(
        ...
        internal enum class Operation(
            ...
            /**
             * Proves that the release is wholly absent or already exact before publication.
             */
            PREFLIGHT("preflight"),

            /**
             * Proves that every immutable publication file is exact after publication.
             */
            VERIFY("verify"),
        }

        /**
         * Owns validation for the public immutable Maven Central repository origin.
         */
        companion object {
